...
Object.assign(STEPS, {
  ...
  l_base: {
    ...
    choices: [
      { id: "network", icon: "ph-broadcast", next: "l_density", accent: "teal", set: { lcontrol: "network" },
      ...
      { id: "base", icon: "ph-cell-tower", next: "l_density", accent: "amber", set: { lcontrol: "base" },
      ...
      { id: "ppk", icon: "ph-clock-counter-clockwise", next: "l_density", accent: "violet", set: { lcontrol: "ppk" },
  ...
  l_class: {
    ...
    choices: [
      { id: "class_full", icon: "ph-mountains", next: "l_check", accent: "amber", set: { lclass: "full" },
      ...
      { id: "class_only", icon: "ph-funnel", next: "l_check", accent: "teal", set: { lclass: "class" },
      ...
      { id: "raw", icon: "ph-cube-transparent", next: "l_check", accent: "violet", set: { lclass: "raw" },
  ...
  l_check: {
    type: "content", phase: 2, visual: "control", next: "crs_output", accent: "teal",
    i18n: {
      tr: {
